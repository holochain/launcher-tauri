...
use lair_keystore_manager::versions::v0_2_0::LairKeystoreManagerV0_2_0;
...
impl LauncherManager {
  pub async fn launch(app_handle: AppHandle) -> Result<Self, LauncherError> {
    ...
    let keystore_path = keystore_data_path(LairKeystoreManagerV0_2_0::lair_keystore_version());

    let is_initialized = LairKeystoreManagerV0_2_0::is_initialized(keystore_path);
  ...
  pub async fn initialize_and_launch_keystore(&mut self, password: String) -> Result<(), String> {
    ...
    LairKeystoreManagerV0_2_0::initialize(keystore_path, password.clone())
      .await
  ...
  pub async fn launch_keystore(&mut self, password: String) -> Result<(), String> {
    ...
    let lair_keystore_manager =
      LairKeystoreManagerV0_2_0::launch(self.config.log_level, keystore_path, password.clone())
        .await
