<template>
  <div class="column card">
    ...
    >
      ...
      <div v-else style="opacity: 0.8; font-size: 15px; min-width: 500px">
        •••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••
      </div>
      <span>
        <svg
    ...
    <div>
      ...
      <div class="column">
        ...
        <div class="row" style="align-items: flex-start">
          <div style="margin-left: 35px; font-size: 0.95em; text-align: right">
            {{ $t("main.incoming") }}:
          </div>
          <div class="row" style="width: 100%; margin: 0 20px">
            <div
              class="column"
              v-if="networkInfo?.fetch_pool_info.op_bytes_to_fetch"
              style="align-items: flex-end; margin-top: 9px"
            >
              <span class="loader"></span>
              <span style="display: flex; flex: 1"></span>
              <span style="font-size: 0.95em">{{
                networkInfo?.fetch_pool_info
                  ? `${prettyBytes(
                      networkInfo?.fetch_pool_info.op_bytes_to_fetch
                    )} in queue`
                  : ""
              }}</span>
            </div>
