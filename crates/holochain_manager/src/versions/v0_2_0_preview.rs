...
use holochain_conductor_api_0_2_0_preview::{
  conductor::{ConductorConfig, KeystoreConfig},
  AdminInterfaceConfig, InterfaceDriver,
};

use holochain_p2p_0_2_0_preview::kitsune_p2p::{KitsuneP2pConfig, ProxyConfig, TransportConfig, dependencies::kitsune_p2p_types::config::tuning_params_struct::KitsuneP2pTuningParams};
...
impl VersionManager for HolochainV0_2_0_beta_96a166 {
  ...
  fn initial_config(
    ...
    network_config.transport_pool.push(TransportConfig::WebRTC { signal_url: String::from("wss://holotest.net") } );
