...
pub use holochain_conductor_api_0_0_172 as holochain_conductor_api_latest;
pub use holochain_types_0_0_172 as holochain_types_latest;
...
pub mod v0_0_172;
pub mod v0_0_172_debug;

use v0_0_172::HolochainV0_0_172;
use v0_0_172_debug::HolochainV0_0_172DEBUG;
...
pub enum HolochainVersion {
  ...
  CustomBinary,
  #[serde(rename = "0.0.172")]
  V0_0_172,
  #[serde(rename = "0.0.172-DEBUG")]
  V0_0_172DEBUG,
}
...
impl HolochainVersion {
  ...
  pub fn manager(&self) -> HolochainVersionManager {
    ...
    match self { // NEW_VERSION assume the latest version for the custom binary
      HolochainVersion::CustomBinary => HolochainVersionManager::HolochainV0_0_172(HolochainV0_0_172),
      HolochainVersion::V0_0_172 => HolochainVersionManager::HolochainV0_0_172(HolochainV0_0_172),
      HolochainVersion::V0_0_172DEBUG => HolochainVersionManager::HolochainV0_0_172DEBUG(HolochainV0_0_172DEBUG),
    }
  }
}
