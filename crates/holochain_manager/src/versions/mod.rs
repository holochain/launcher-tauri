...
impl HolochainVersion {
  ...
  pub fn manager(&self) -> HolochainVersionManager {
    ...
    match self { // NEW_VERSION assume the latest version for the custom binary
      HolochainVersion::CustomBinary => HolochainVersionManager::HolochainV0_1_3(HolochainV0_1_3),
      HolochainVersion::V0_1_3 => HolochainVersionManager::HolochainV0_1_3(HolochainV0_1_3),
    }
  }
}
