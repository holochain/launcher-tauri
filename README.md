...
10. Click on "Continue" and then set the appropriate "Name" for your release (e.g. v0.0.1, *this is the version name that participants will see when downloading your application*) as well as a changelog.
