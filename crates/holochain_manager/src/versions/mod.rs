...
pub use holochain_conductor_api_0_0_173 as holochain_conductor_api_latest;
pub use holochain_types_0_0_173 as holochain_types_latest;
...
impl HolochainVersion {
  ...
  pub fn manager(&self) -> HolochainVersionManager {
    ...
    match self { // NEW_VERSION assume the latest version for the custom binary
      HolochainVersion::CustomBinary => HolochainVersionManager::HolochainV0_0_173(HolochainV0_0_173),
      HolochainVersion::V0_0_173 => HolochainVersionManager::HolochainV0_0_173(HolochainV0_0_173),
    }
  }
}
