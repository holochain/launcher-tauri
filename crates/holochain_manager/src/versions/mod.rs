...
pub use holochain_conductor_api_0_1_0BetaRc0 as holochain_conductor_api_latest;
pub use holochain_types_0_1_0BetaRc0 as holochain_types_latest;
...
pub mod v0_1_0BetaRc0;

use v0_1_0BetaRc0::HolochainV0_1_0BetaRc0;
...
impl HolochainVersion {
  ...
  pub fn default() -> HolochainVersion {
    HolochainVersion::V0_1_0BetaRc0
  }
  ...
  pub fn manager(&self) -> HolochainVersionManager {
    ...
    match self { // NEW_VERSION assume the latest version for the custom binary
      HolochainVersion::CustomBinary => HolochainVersionManager::HolochainV0_1_0BetaRc0(HolochainV0_1_0BetaRc0),
      HolochainVersion::V0_1_0BetaRc0 => HolochainVersionManager::HolochainV0_1_0BetaRc0(HolochainV0_1_0BetaRc0),
    }
  }
}
