...
use crate::{LairKeystoreManager, error::LaunchTauriSidecarError};
...
impl LairKeystoreManager for LairKeystoreManagerV0_0_9 {
    ...
    async fn launch(log_level: log::Level, keystore_path: PathBuf) -> Result<Self, LaunchTauriSidecarError> {
