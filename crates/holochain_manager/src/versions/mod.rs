...
pub use holochain_conductor_api_0_2_0_rc1 as holochain_conductor_api_latest;
pub use holochain_types_0_2_0_rc1 as holochain_types_latest;
...
use v0_2_0_rc1::HolochainV0_2_0_rc1;
...
impl HolochainVersion {
  ...
  pub fn manager(&self) -> HolochainVersionManager {
    ...
    match self { // NEW_VERSION assume the latest version for the custom binary
      HolochainVersion::CustomBinary => HolochainVersionManager::HolochainV0_2_0_rc1(HolochainV0_2_0_rc1),
      HolochainVersion::V0_2_0_rc1 => HolochainVersionManager::HolochainV0_2_0_rc1(HolochainV0_2_0_rc1),
    }
  }
}
