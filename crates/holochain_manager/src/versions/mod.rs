...
pub use holochain_conductor_api_0_2_4 as holochain_conductor_api_latest;
pub use holochain_types_0_2_4 as holochain_types_latest;
...
impl HolochainVersion {
  ...
  pub fn supported_versions() -> Vec<HolochainVersion> {
    ...
    return vec![HolochainVersion::V0_2_4];
  }
  ...
  pub fn manager(&self) -> HolochainVersionManager {
    ...
    match self {
      ...
      HolochainVersion::CustomBinary => HolochainVersionManager::HolochainV0_2_4(HolochainV0_2_4),
      HolochainVersion::V0_2_4 => HolochainVersionManager::HolochainV0_2_4(HolochainV0_2_4),
    }
  }
}
