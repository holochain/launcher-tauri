...
use self::v0_0_132::HolochainManagerV0_0_132;
...
impl HolochainVersion {
  pub fn hdk_version(&self) -> HdkVersion {
    match self {
      HolochainVersion::V0_0_132 => HdkVersion::V0_0_127,
    }
  }

  pub fn lair_keystore_version(&self) -> LairKeystoreVersion {
    match self {
      HolochainVersion::V0_0_132 => LairKeystoreVersion::V0_1_0,
    }
  }
  ...
  pub fn supported_versions() -> Vec<HolochainVersion> {
    return vec![HolochainVersion::V0_0_132];
  }
}
...
impl Into<String> for HolochainVersion {
  fn into(self) -> String {
    match self {
      HolochainVersion::V0_0_132 => String::from("v0.0.132"),
    }
  }
}
...
impl TryFrom<String> for HolochainVersion {
  ...
  fn try_from(s: String) -> Result<HolochainVersion, String> {
    match s.as_str() {
      "v0.0.132" => Ok(HolochainVersion::V0_0_132),
...
pub async fn launch_holochain(
  ...
  match holochain_version {
    HolochainVersion::V0_0_132 => Ok(HolochainManagerEnum::HolochainManagerV0_0_132(
      HolochainManagerV0_0_132::launch(config, password).await?,
    )),
  }
}
