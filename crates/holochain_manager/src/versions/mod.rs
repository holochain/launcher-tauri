...
pub use holochain_conductor_api_0_0_161 as holochain_conductor_api_latest;
pub use holochain_types_0_0_161 as holochain_types_latest;
...
use v0_0_161::HolochainV0_0_161;
...
impl HolochainVersion {
  ...
  pub fn manager(&self) -> HolochainVersionManager {
    ...
    match self {
      ...
      HolochainVersion::V0_0_161 => HolochainVersionManager::HolochainV0_0_161(HolochainV0_0_161),
    }
  }
}
